...
# on line 7, the product variable is initalised with a value of 0. On line 10 the value of product is incremented by its value multiplied by the value of each digit. The value will only ever be 0. Product should be initalised with a value of 1.
