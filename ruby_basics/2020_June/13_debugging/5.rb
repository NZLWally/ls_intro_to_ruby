...
# #map transforms each element and returns an array of the transformed elements. Need #select which will return an array of each element that the block returns true
