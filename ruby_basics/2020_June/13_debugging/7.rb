...
# the balance variable is re-assigned for each iteration of the #each method. We need to increment it by the return of calculate_balance(month) for each iteration
